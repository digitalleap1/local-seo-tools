...
Author: Mukesh Kr · techie1418@gmail.com
"""
...
{areas}
<div class=foot>Generated by GBP/Local SEO Deep Auto-Auditor (python-local-v2) · {datetime.now().strftime('%Y-%m-%d %H:%M')}<br>Mukesh Kr · techie1418@gmail.com</div></div></body></html>"""
